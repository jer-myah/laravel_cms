                        ...
                        <div class='max-w-md mx-auto space-y-6'>            
                            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                                <div class="mx-auto max-w-screen-sm text-center">
                                    ...
                                    <p class="mb-4 text-3xl tracking-tight font-bold text-black md:text-4xl">No page page found</p>
                                    <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">There are no page(s) for the selected category. </p>
                                </div>   
                            </div>            
                        </div>
                        @endif
