                    ...
                    <div class="container mx-auto py-8">
                        ...
                        <form method="POST" action="{{ route('admin.pages.store') }}" enctype="multipart/form-data" class="w-full mx-auto bg-white p-8 rounded-md shadow-md">
                            ...
                            <div class="mb-4">
                                ...
                                type="text" name="title" placeholder="Page Title" required>
                            </div>
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="cover_image">Cover image</label>
                                <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-teal-500"
                                type="file" name="image" placeholder="Cover Image" required>
                            </div>
                            <div class="mb-4">
